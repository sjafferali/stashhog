...
def test_imports():
    ...
    try:
        ...
        from app.core.exceptions import StashHogException  # noqa: F401
        from app.core.logging import configure_logging  # noqa: F401
        from app.core.middleware import RequestIDMiddleware  # noqa: F401
...
if __name__ == "__main__":
    ...
    tests = [test_imports, test_endpoints, test_settings]
