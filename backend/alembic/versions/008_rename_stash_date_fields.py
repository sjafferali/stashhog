...
def upgrade() -> None:
    ...
    if is_sqlite:
        ...
        # Recreate indexes
        op.create_index(
            "idx_scene_organized_date", "scene", ["organized", "stash_date"]
        )
        ...
        op.create_index(
            "idx_scene_analyzed_organized", "scene", ["analyzed", "organized"]
        )
...
def downgrade() -> None:
    ...
    if is_sqlite:
        ...
        op.create_index(
            "idx_scene_organized_date", "scene", ["organized", "scene_date"]
        )
