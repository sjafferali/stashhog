...
class StashAPIError(StashHogException):
    ...
    def __init__(self, message: str, response_code: Optional[int] = None, response_body: Optional[str] = None):
        """
...
class OpenAIError(StashHogException):
    ...
    def __init__(self, message: str, model: Optional[str] = None, api_error: Optional[str] = None):
        """
