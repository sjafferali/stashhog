...
async def sync_scenes_task(
    filter_params: Dict[str, Any], limit: Optional[int] = None
) -> Dict[str, Any]:
...
async def analyze_scene_task(scene_id: str, options: Dict[str, Any]) -> Dict[str, Any]:
