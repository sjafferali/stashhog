...
from sqlalchemy import Column, String, DateTime, Index, Boolean, Integer, Text, JSON, ForeignKey
...
class Studio(BaseModel):
    ...
    # Hierarchy
    parent_id = Column(Integer, ForeignKey("studio.id", ondelete="SET NULL"), nullable=True)
    ...
    def get_recent_scenes(self, limit: int = 10) -> List["Scene"]:
        ...
        return self.scenes.order_by("scene_date desc").limit(limit).all()
