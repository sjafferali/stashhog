...
scene_performer = Table(
    ...
    Base.metadata,
    Column(
        "scene_id", String, ForeignKey("scene.id", ondelete="CASCADE"), primary_key=True
    ),
    Column(
        "performer_id",
        String,
        ForeignKey("performer.id", ondelete="CASCADE"),
        primary_key=True,
    ),
...
scene_tag = Table(
    ...
    Column(
        "tag_id", String, ForeignKey("tag.id", ondelete="CASCADE"), primary_key=True
    ),
