...
from sqlalchemy import Column, Integer, String, Boolean, JSON, DateTime, UniqueConstraint, Index
...
class ScheduledTask(BaseModel):
    ...
    task_type = Column(String, nullable=False, index=True)  # sync, analysis, cleanup, etc.
    ...
    def mark_executed(self, job_id: str) -> None:
        ...
        self.update_next_run(self.last_run)
