...
from sqlalchemy import Column, Integer, String, Float, Boolean, JSON, DateTime, ForeignKey, Enum, Index
...
class PlanChange(BaseModel):
    ...
    # Foreign keys
    plan_id = Column(Integer, ForeignKey("analysis_plan.id", ondelete="CASCADE"), nullable=False, index=True)
    scene_id = Column(String, ForeignKey("scene.id", ondelete="CASCADE"), nullable=False, index=True)
    
    # Change details
    field = Column(String, nullable=False, index=True)  # performer, tag, studio, details, etc.
