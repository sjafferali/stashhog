...
from app.core.tasks import task_queue, TaskStatus
...
class JobService:
    ...
    async def create_job(
        ...
        **kwargs
        ...
        task_id = await task_queue.create_task(
            ...
            func=task_wrapper,
            callback=lambda status, result=None, error=None: self._task_callback(
    ...
    async def _send_job_update(self, job_id: str, data: Dict[str, Any]):
    ...
    async def cleanup_old_jobs(self, db: Session, days: int = 30) -> int:
