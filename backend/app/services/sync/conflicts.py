...
class ConflictResolver:
    ...
    def __init__(self, default_strategy: ConflictStrategy = ConflictStrategy.REMOTE_WINS):
    ...
    def resolve_scene_conflict(
        ...
        if strategy == ConflictStrategy.REMOTE_WINS:
            return self._apply_remote_wins(local, remote)
        elif strategy == ConflictStrategy.LOCAL_WINS:
            return local  # No changes needed
        elif strategy == ConflictStrategy.MERGE:
            return self._apply_merge_strategy(local, remote, changes)
    ...
    def _detect_scene_changes(self, local: Scene, remote: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _detect_performer_changes(self, local: Performer, remote: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _detect_studio_changes(self, local: Studio, remote: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _detect_relationship_changes(self, local: Scene, remote: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _apply_remote_wins(self, local: Any, remote: Dict[str, Any]) -> Any:
        ...
        if isinstance(local, Scene):
            ...
            local.details = remote.get("details")
            local.url = remote.get("url")
            local.date = remote.get("date")
            local.rating = remote.get("rating")
