...
class TagDetector:
    ...
    def _build_reverse_hierarchy(self):
                ...
                for tag in tags:
                    if tag.lower() not in existing_lower:
                        results.append(DetectionResult(
                            ...
                            confidence=0.95,
                            source="technical",
                            metadata={"type": "resolution", "width": width, "height": height}
                        ))
        ...
        for tag in current_tags:
            ...
            if tag_lower in related_map:
                for related in related_map[tag_lower]:
                    if related not in current_lower and any(related in t.lower() for t in all_available_tags):
                        suggestions.append(DetectionResult(
                            value=related,
                            confidence=0.6,
                            source="related",
