...
import { ArrowLeftOutlined, EditOutlined, RobotOutlined } from '@ant-design/icons'
      ...
      <Card
        ...
        extra={
          <Space>
            ...
            <Button type="primary" icon={<RobotOutlined />}>Analyze</Button>
          </Space>
        }
      >
        <Descriptions bordered>
          ...
          <Descriptions.Item label="Path" span={3}>-</Descriptions.Item>
